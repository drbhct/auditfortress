...
export const Grid: React.FC<GridProps> = ({
  ...
  return (
    <div className={cn('grid', colsClasses[cols], gapClasses[gap], responsiveClasses, className)}>
      {children}
    </div>
  )
}
...
export const GridItem: React.FC<GridItemProps> = ({
  ...
  return <div className={cn(spanClasses[span], responsiveClasses, className)}>{children}</div>
}
